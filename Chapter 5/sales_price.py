...
# The discont function accepts an item's price as an argument and returns the amount of the discount, specified by DISCOUNT_PERCENTAGE.
def discount(price):
